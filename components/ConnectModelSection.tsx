  ...
  const connectPoints: ConnectPoint[] = [
    {
      letter: "C",
      title: "Communication",
      description: "Honest and open discussions that bring clarity. Effective communication creates a foundation for understanding each other's needs, desires, and concerns."
    },
    {
      letter: "O",
      title: "Openness",
      description: "Willingness to be vulnerable and transparent. Being open with your partner builds trust and allows for deeper connection as you share your authentic self."
    },
    {
      letter: "N",
      title: "Nurturing",
      description: "Caring for each other emotionally, physically, and spiritually. Nurturing each other's growth creates a supportive environment where both partners can thrive."
    },
    {
      letter: "N",
      title: "Negotiation",
      description: "Finding balance and compromise in conflicts. Healthy negotiation acknowledges that both partners' needs matter and works toward solutions that honor both perspectives."
    },
    {
      letter: "E",
      title: "Empathy",
      description: "Understanding and valuing each other's experiences. Empathy allows you to connect with your partner's feelings and see the world through their eyes."
    },
    {
      letter: "C",
      title: "Commitment",
      description: "Staying dedicated to growth and love. Commitment is the daily choice to invest in your relationship even during challenging seasons."
    },
    {
      letter: "T",
      title: "Trust",
      description: "The foundation of emotional and relational security. Trust creates a safe space where both partners can be fully themselves without fear of judgment or betrayal."
    },
  ];
